        ...
        <div class="bg-white-100 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex items-center justify-center p-4">
                <div class="bg-white flex items-center justify-center flex-col">
                    ...
                    <form action="{{ route('film.store') }}" method="POST" class="w-full bg-white rounded-lg p-8">
                        @csrf
                        @method('POST')
                        <div class="py-4">
                            <h2 class="text-3xl font-bold tracking-wide text-black text-center">Catat Filmu Disini!
                            </h2>
                        </div>
                        <div class="flex flex-col space-y-4">
                            <div>
                                <label for="text" class="text-black">Judul :</label>
                                <input type="text" placeholder="Masukan judul" id="text" name="judul"
                            ...
                            <div>
                                ...
                                <input type="number" placeholder="Masukan tahun terbit film" id="number"
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" id="checkbox" class="mr-2" name="isCompleted" value="1"/>
